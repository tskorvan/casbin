...
import (
	...
	"github.com/tskorvan/casbin/effect"
	"github.com/tskorvan/casbin/log"
	"github.com/tskorvan/casbin/model"
	"github.com/tskorvan/casbin/persist"
	fileadapter "github.com/tskorvan/casbin/persist/file-adapter"
	"github.com/tskorvan/casbin/rbac"
	defaultrolemanager "github.com/tskorvan/casbin/rbac/default-role-manager"
	"github.com/tskorvan/casbin/util"
)
...
func (e *Enforcer) enforce(matcher string, rvals ...interface{}) (bool, error) {
	...
	var policyEffects []effect.HierarchyEffect
	var matcherResults []float64
	if policyLen := len(e.model["p"]["p"].Policy); policyLen != 0 {
		policyEffects = make([]effect.HierarchyEffect, policyLen)
		...
		for i, pvals := range e.model["p"]["p"].Policy {
			...
			case bool:
				if !result {
					policyEffects[i] = effect.HierarchyEffect{
		...
		policyEffects = make([]effect.HierarchyEffect, 1)
		...
		if result.(bool) {
			policyEffects[0] = effect.HierarchyEffect{
				Effect: effect.Allow,
				Level:  0,
			}
		} else {
