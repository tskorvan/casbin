...
Before raising a new issue, check our [issue list](https://github.com/tskorvan/casbin/issues) to determine if it already contains the problem that you are facing.
